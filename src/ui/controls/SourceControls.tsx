 ...
 *
 * Modules: oscillator, supersaw, karplus, nes-osc, snes-osc, noise, tb-303, fm-op, fm-matrix, shepard, pipe-organ, spectral-swarm, resonator, wavetable
 */
