...
| **FM Op** | `fm-op` | 2x3 | `pitch` (cv), `gate` (gate), `fm` (audio), `index-cv` (cv) | `out` (audio) | `frequency`=440, `ratio`=1, `level`=1, `feedback`=0, `attack`=10, `decay`=200, `sustain`=0.7, `release`=300 |
