...
fn normalize_module_type(raw: &str) -> ModuleType {
  match raw {
    "oscillator" | "wasm-osc" => ModuleType::Oscillator,
    "gain" | "wasm-gain" => ModuleType::Gain,
    "cv-vca" | "wasm-cv-vca" => ModuleType::CvVca,
    "output" => ModuleType::Output,
    "lab" => ModuleType::Lab,
    "lfo" | "wasm-lfo" => ModuleType::Lfo,
    "adsr" | "wasm-adsr" => ModuleType::Adsr,
    "vcf" | "wasm-vcf" => ModuleType::Vcf,
    "mixer" | "wasm-mixer" => ModuleType::Mixer,
    "chorus" | "wasm-chorus" => ModuleType::Chorus,
    "delay" | "wasm-delay" => ModuleType::Delay,
    "reverb" | "wasm-reverb" => ModuleType::Reverb,
