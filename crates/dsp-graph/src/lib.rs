...
use dsp_core::{
  // DSP structs for instantiation
  Adsr, Arpeggiator, Choir, Chorus, Clap909, Delay, Distortion, DrumSequencer, Ensemble,
  ...
  Quantizer, Reverb, RingMod, Rimshot909, SampleHold, SlewLimiter, Snare909, SnesOsc, SpringReverb,
  StepSequencer, Supersaw, TapeDelay, Tb303, Tom909, Vcf, Vco, Vocoder, Wavefolder,
  // Params and Inputs for processing
  AdsrInputs, AdsrParams, ArpeggiatorInputs, ArpeggiatorOutputs, ArpeggiatorParams,
  ChoirInputs, ChoirParams, ChorusInputs, ChorusParams, Clap909Inputs,
  Clap909Params, DelayInputs, DelayParams, DistortionParams,
  DrumSequencerInputs, DrumSequencerOutputs, DrumSequencerParams, EnsembleInputs,
  EnsembleParams, EuclideanInputs, EuclideanParams, FmOperatorInputs,
  FmOperatorParams, GranularDelayInputs, GranularDelayParams, HiHat909Inputs,
  HiHat909Params, HpfInputs, HpfParams, KarplusInputs, KarplusParams,
  Kick909Inputs, Kick909Params, LfoInputs, LfoParams,
  MasterClockInputs, MasterClockOutputs, MasterClockParams, Mixer, NesOscInputs, NesOscParams,
  NoiseParams, PhaserInputs, PhaserParams, PitchShifterInputs,
  PitchShifterParams, QuantizerInputs, QuantizerParams, ReverbInputs, ReverbParams,
  Rimshot909Inputs, Rimshot909Params, RingModParams, Sample,
  SampleHoldInputs, SampleHoldParams, SlewInputs, SlewParams, Snare909Inputs,
  Snare909Params, SnesOscInputs, SnesOscParams, SpringReverbInputs,
  SpringReverbParams, StepSequencerInputs, StepSequencerOutputs, StepSequencerParams,
  SupersawInputs, SupersawParams, TapeDelayInputs, TapeDelayParams,
  Tb303Inputs, Tb303Outputs, Tb303Params, Tom909Inputs, Tom909Params, Vca, VcfInputs,
  VcfParams, VcoInputs, VcoParams, VocoderInputs, VocoderParams,
