...
pub(crate) fn apply_param(state: &mut ModuleState, param: &str, value: f32) {
  match state {
    ...
    ModuleState::DrumMachine909(state) => match param {
      "enabled" => state.enabled.set(value),
      "rate" => state.rate.set(value),
      "swing" => state.swing.set(value),
      "length" => state.length.set(value),
      "pattern" => state.pattern.set(value),
      "fill" => state.fill.set(value),
      "bd-tune" => state.bd_tune.set(value),
      "bd-decay" => state.bd_decay.set(value),
      "bd-level" => state.bd_level.set(value),
      "sd-tune" => state.sd_tune.set(value),
      "sd-snappy" => state.sd_snappy.set(value),
      "sd-decay" => state.sd_decay.set(value),
      "sd-level" => state.sd_level.set(value),
      "lt-tune" => state.lt_tune.set(value),
      "lt-decay" => state.lt_decay.set(value),
      "lt-level" => state.lt_level.set(value),
      "mt-tune" => state.mt_tune.set(value),
      "mt-decay" => state.mt_decay.set(value),
      "mt-level" => state.mt_level.set(value),
      "ht-tune" => state.ht_tune.set(value),
      "ht-decay" => state.ht_decay.set(value),
      "ht-level" => state.ht_level.set(value),
      "rs-tune" => state.rs_tune.set(value),
      "rs-level" => state.rs_level.set(value),
      "cp-tone" => state.cp_tone.set(value),
      "cp-decay" => state.cp_decay.set(value),
      "cp-level" => state.cp_level.set(value),
      "ch-tune" => state.ch_tune.set(value),
      "ch-decay" => state.ch_decay.set(value),
      "ch-level" => state.ch_level.set(value),
      "oh-tune" => state.oh_tune.set(value),
      "oh-decay" => state.oh_decay.set(value),
      "oh-level" => state.oh_level.set(value),
      "cr-tune" => state.cr_tune.set(value),
      "cr-decay" => state.cr_decay.set(value),
      "cr-tone" => state.cr_tone.set(value),
      "cr-level" => state.cr_level.set(value),
      "rd-tune" => state.rd_tune.set(value),
      "rd-decay" => state.rd_decay.set(value),
      "rd-bell" => state.rd_bell.set(value),
      "rd-level" => state.rd_level.set(value),
      _ => {}
    },
    // TR-808 Drums
