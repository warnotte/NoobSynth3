...
pub(crate) fn create_state(
  ...
  match module_type {
    ...
    ModuleType::Koshi => ModuleState::Koshi(KoshiState {
      koshi: Koshi::new(sample_rate),
      tuning: ParamBuffer::new(param_number(params, "tuning", 0.0)),
      wind: ParamBuffer::new(param_number(params, "wind", 0.5)),
      gust: ParamBuffer::new(param_number(params, "gust", 0.5)),
      sustain: ParamBuffer::new(param_number(params, "sustain", 1.0)),
      brightness: ParamBuffer::new(param_number(params, "brightness", 0.5)),
      body: ParamBuffer::new(param_number(params, "body", 0.5)),
