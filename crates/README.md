...
Bibliothèque de traitement audio sans dépendance externe (~25800 lignes, 94 fichiers).
...
| `drums/` | TR-909 + TR-808 (Kick, Snare, HiHat, Clap, Tom, Rimshot, Cowbell, Crash, Ride) (14) |
| `sequencers/` | Clock, Arpeggiator, Step, Drum, Euclidean, Mario, SID/AY players, Game of Life, Gravity, Harmonist, Chord, Polyrhythm, Turing Machine… (17) |
