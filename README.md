...
- **52 modules** : VCO, Supersaw, Karplus-Strong, NES/SNES Osc, TB-303, FM Op, TR-909 Drums (Kick/Snare/HiHat/Clap/Tom/Rimshot), Drum Sequencer (8-track), Euclidean Sequencer, Noise, Audio In, Sample & Hold, Slew, Quantizer, VCF (SVF/Ladder), LFO, ADSR, Step Sequencer, Arpeggiator, Ensemble/Choir, Delay/Tape/Granular, Spring/Reverb, Pitch Shifter, Wavefolder...
